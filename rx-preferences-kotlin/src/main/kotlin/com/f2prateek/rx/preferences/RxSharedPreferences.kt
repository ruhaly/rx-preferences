...
fun <T : Enum<T>> SharedPreferences.getEnum(key: String, defaultValue: T, enumClass: Class<T>): Preference<T> {
...
fun <T> SharedPreferences.getObject(key: String, defaultValue: T, adapter: Preference.Adapter<T>): Preference<T> {
...
fun SharedPreferences.getStringSet(key: String, defaultValue: Set<String>): Preference<Set<String>> {
